...
class CheckLoanEligibilityView(View):
    def post(self, request):
        ...
        # Retrieve loan data from database
        loan_data_query = Loan.objects.filter(customer_info_id=customer_id)



        # Implement your credit score calculation logic here using loan_data_query
        credit_score = calculate_credit_score(loan_data_query, customer.approved_limit)
        print("credit_score: ", credit_score)

        # Implement your loan approval logic here based on credit score and other conditions
        ...
        # If approved calculate monthly installment
        if approval_data['approval']:
            ...
            # Sending appropiate message if not approved
...
class ViewLoanDetailsByLoanIdView(View):
    def get(self, request, loan_id):
        ...
        # Serialize loan and customer details
        loan_data = {
            ...
            'loan_amount': loan.loan_amount,  # Assuming this indicates whether the loan is approved or not
...
class CreateLoanView(View):
    ...
    def post(self, request):
        ...
        # Make request to loan eligibility endpoint
        ...
        if response.status_code == 200:
            ...
            if loan_eligibility_data['approval']:
                ...
                # Loan not approved, return message
                return JsonResponse({
                    'loan_id': None,
                    'customer_id': customer_id,
                    'loan_approved': False,
            ...
            # Error in requesting loan eligibility
...
def calculate_credit_score(loan_data_query, approved_limit):
    # Initialize variables to store information for credit score calculation
